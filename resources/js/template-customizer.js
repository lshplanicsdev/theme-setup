...
const DEFAULT_SKIN =
    document.getElementsByTagName("HTML")[0].getAttribute("data-skin") || 0;
...
class TemplateCustomizer {
    constructor({
        ...
        if (defaultPrimaryColor) {
            ...
            this.settings.defaultPrimaryColor = rootStyles
        ...
        this.settings.defaultHeaderType =
            defaultHeaderType || DEFAULT_HEADER_TYPE;
        ...
        this.settings.availableSkins =
            availableSkins || TemplateCustomizer.SKINS;
    ...
    _setup(_container = document) {
      ...
      `;
        ...
        // Color
        const colorW = this.container.querySelector(
          ...
          <input
            ...
            const colorCb = (e) => {
                if (e.target.value === "picker") {
                    document
                        .querySelector(".custom-option-content .pcr-button")
                        .click();
                } else {
        ...
        // Theme
        const themeW = this.container.querySelector(
        ...
        if (!this._hasControls("theme")) {
            ...
            if (
                themeOpt.querySelector(
                    `input[value="${this.settings.themesOpt}"]`
                )
            ) {
                themeOpt
        ...
        // Skin
        const skinsW = this.container.querySelector(
