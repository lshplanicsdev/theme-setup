                    ...
                    <div class="row">
                      ...
                      <div class="col-6 text-end d-flex align-items-end">
                        <div class="card-body pb-0 pt-7">
                          <img
                            src="{{ Vite::asset('resources/assets/img/illustrations/card-ratings-illustration.png')}}"
                            alt="Ratings"
                            class="img-fluid"
                            width="95" />
                        </div>
                  ...
                  <div class="card h-100">
                    <div class="row">
                      ...
                      <div class="col-6 text-end d-flex align-items-end">
                        <div class="card-body pb-0 pt-7">
                          <img
                            src="{{ Vite::asset('resources/assets/img/illustrations/card-session-illustration.png')}}"
                            alt="Ratings"
                            class="img-fluid"
                            width="81" />
                        </div>
                    ...
                    <div class="swiper-wrapper">
                      <div class="swiper-slide pb-5">
                        <div class="row">
                          ...
                          <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-2 my-md-0 text-center">
                            <img
                              src="{{ Vite::asset('resources/assets/img/products/card-weekly-sales-phone.png')}}"
                              alt="weekly sales"
                              width="240"
                      ...
                      <div class="swiper-slide pb-5">
                        <div class="row">
                          ...
                          <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-2 my-md-0 text-center">
                            <img
                              src="{{ Vite::asset('resources/assets/img/products/card-weekly-sales-controller.png')}}"
                              alt="weekly sales"
                              width="240"
                              class="weekly-sales-img" />
                          </div>
                      ...
                      <div class="swiper-slide pb-5">
                        <div class="row">
                          ...
                          <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-2 my-md-0 text-center">
                            <img
                              src="{{ Vite::asset('resources/assets/img/products/card-weekly-sales-watch.png')}}"
                              alt="weekly sales"
                              width="240"
                              class="weekly-sales-img" />
                          </div>
                          ...
                          <div class="timeline-event">
                            ...
                            <div class="d-flex align-items-center mb-1">
                              <div class="badge bg-lightest rounded-3">
                                <img src="{{ Vite::asset('resources/assets//img/icons/misc/pdf.png')}}" alt="img" width="20" class="me-2" />
                            ...
                            <div class="d-flex justify-content-between flex-wrap gap-2">
                              <div class="d-flex flex-wrap align-items-center">
                                <div class="avatar avatar-sm me-2">
                                  <img src="{{ Vite::asset('resources/assets/img/avatars/1.png')}}" alt="Avatar" class="rounded-circle" />
                                </div>
                                <div>
                                ...
                                <div class="d-flex flex-wrap align-items-center">
                                  <ul class="list-unstyled users-list d-flex align-items-center avatar-group m-0 me-2">
                                    <li
                                      ...
                                      <img class="rounded-circle" src="{{ Vite::asset('resources/assets/img/avatars/5.png')}}" alt="Avatar" />
                                    </li>
                                    <li
                                      data-bs-toggle="tooltip"
                                      data-popup="tooltip-custom"
                                      ...
                                      title="Allen Rieske"
                                      class="avatar pull-up">
                                      <img class="rounded-circle" src="{{ Vite::asset('resources/assets/img/avatars/12.png')}}" alt="Avatar" />
                                    </li>
                                    <li
                                      data-bs-toggle="tooltip"
                                      data-popup="tooltip-custom"
                                      ...
                                      class="avatar pull-up">
                                      <img class="rounded-circle" src="{{ Vite::asset('resources/assets/img/avatars/6.png')}}" alt="Avatar" />
                                    </li>
                                    <li class="avatar">
                                      <span
                      ...
                      <ul
                        ...
                        <li class="nav-item">
                          <a
                            ...
                            aria-selected="true">
                            <div>
                              <img src="{{ Vite::asset('resources/assets/img/products/apple-iPhone-13.png')}}" alt="Mobile" class="img-fluid" />
                            </div>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a
                            ...
                            <div>
                              <img
                                src="{{ Vite::asset('resources/assets/img/products/apple-iMac-3k.png')}}"
                                alt="Apple iMac 3k"
                                class="img-fluid" />
                            </div>
                          </a>
                        ...
                        <li class="nav-item">
                          <a
                            ...
                            <div>
                              <img
                                src="{{ Vite::asset('resources/assets/img/products/gaming-remote.png')}}"
                                alt="Gaming Remote"
                                class="img-fluid" />
                            </div>
                          </a>
                          ...
                          <table class="table border-top">
                            ...
                            <tbody class="table-border-bottom-0">
                              <tr>
                                <td>
                                  <img
                                    src="{{ Vite::asset('resources/assets/img/products/samsung-s22.png')}}"
                                    alt="Mobile"
                                    width="34"
                                    height="34"
                                    class="rounded" />
                              ...
                              <tr>
                                <td>
                                  <img
                                    src="{{ Vite::asset('resources/assets/img/products/apple-iPhone-13-pro.png')}}"
                                    alt="Mobile"
                                    width="34"
                                    height="34"
                                    class="rounded" />
                              ...
                              <tr>
                                <td>
                                  <img
                                    src="{{ Vite::asset('resources/assets/img/products/oneplus-9-pro.png')}}"
                                    alt="Mobile"
                                    width="34"
                                    height="34"
                                    class="rounded" />
                              ...
                              <tr>
                                <td>
                                  <img
                                    src="{{ Vite::asset('resources/assets/img/products/google-pixel-6.png')}}"
                                    alt="Mobile"
                                    width="34"
                                    height="34"
                                    class="rounded" />
                          ...
                          <table class="table border-top">
                            ...
                            <tbody class="table-border-bottom-0">
                              <tr>
                                <td>
                                  <img
                                    src="{{ Vite::asset('resources/assets/img/products/apple-mac-mini.png')}}"
                                    alt="Mobile"
                                    width="34"
                                    height="34"
                                    class="rounded" />
                              ...
                              <tr>
                                <td>
                                  <img
                                    src="{{ Vite::asset('resources/assets/img/products/hp-envy-x360.png')}}"
                                    alt="Mobile"
                                    width="34"
                                    height="34"
                                    class="rounded" />
                              ...
                              <tr>
                                <td>
                                  <img
                                    src="{{ Vite::asset('resources/assets/img/products/dell-inspiron-3000.png')}}"
                                    alt="Mobile"
                                    width="34"
                                    height="34"
                                    class="rounded" />
                              ...
                              <tr>
                                <td>
                                  <img
                                    src="{{ Vite::asset('resources/assets/img/products/apple-iMac-4k.png')}}"
                                    alt="Mobile"
                                    width="34"
                                    height="34"
                                    class="rounded" />
                          ...
                          <table class="table border-top">
                            ...
                            <tbody class="table-border-bottom-0">
                              <tr>
                                <td>
                                  <img
                                    src="{{ Vite::asset('resources/assets/img/products/sony-play-station-5.png')}}"
                                    alt="Mobile"
                                    width="34"
                                    height="34"
                                    class="rounded" />
                              ...
                              <tr>
                                <td>
                                  <img
                                    src="{{ Vite::asset('resources/assets/img/products/xbox-series-x.png')}}"
                                    alt="Mobile"
                                    width="34"
                                    height="34"
                                    class="rounded" />
                              ...
                              <tr>
                                <td>
                                  <img
                                    src="{{ Vite::asset('resources/assets/img/products/nintendo-switch.png')}}"
                                    alt="Mobile"
                                    width="34"
                                    height="34"
                                    class="rounded" />
                              ...
                              <tr>
                                <td>
                                  <img
                                    src="{{ Vite::asset('resources/assets/img/products/sup-game-box-400.png')}}"
                                    alt="Mobile"
                                    width="34"
                                    height="34"
                                    class="rounded" />
                      ...
                      <div class="d-flex align-items-center gap-4">
                        <div>
                          <div
                            ...
                            data-color="primary"
                            data-series="70"
                            data-icon="{{ Vite::asset('resources/assets/img/icons/misc/card-icon-laptop.png')}}"></div>
                        </div>
                        <div>
                          <div class="card-info">
                      ...
                      <div class="d-flex align-items-center gap-4">
                        <div>
                          <div
                            ...
                            data-color="warning"
                            data-series="40"
                            data-icon="{{ Vite::asset('resources/assets/img/icons/misc/card-icon-bag.png')}}"></div>
                        </div>
                        <div>
                          <div class="card-info">
                            <div class="d-flex align-items-center gap-2 flex-wrap">
                    ...
                    <div class="swiper-wrapper">
                      <div class="swiper-slide card pb-5 shadow-none border-0">
                        ...
                        <div class="d-flex align-items-center mt-5">
                          <img
                            src="{{ Vite::asset('resources/assets/img/products/card-marketing-expense-logo.png')}}"
                      ...
                      <div class="swiper-slide card pb-5 shadow-none border-0">
                        ...
                        <div class="d-flex align-items-center mt-5">
                          <img
                            src="{{ Vite::asset('resources/assets/img/products/card-accounting-logo.png')}}"
                            alt="Marketing and sales"
                            width="84"
                            class="rounded-4" />
                          <div class="d-flex flex-column w-100 ms-6">
                      ...
                      <div class="swiper-slide card pb-5 shadow-none border-0">
                        ...
                        <div class="d-flex align-items-center mt-5">
                          <img
                            src="{{ Vite::asset('resources/assets/img/products/card-sales-overview-logo.png')}}"
                            alt="Marketing and sales"
                            width="84"
                            class="rounded-4" />
                          <div class="d-flex flex-column w-100 ms-6">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="avatar avatar-sm me-4">
                                  <img src="{{ Vite::asset('resources/assets/img/avatars/3.png')}}" alt="Avatar" class="rounded-circle" />
                                </div>
                                <div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="avatar avatar-sm me-4">
                                  <img src="{{ Vite::asset('resources/assets/img/avatars/2.png')}}" alt="Avatar" class="rounded-circle" />
                                </div>
                                <div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="avatar avatar-sm me-4">
                                  <img src="{{ Vite::asset('resources/assets/img/avatars/4.png')}}" alt="Avatar" class="rounded-circle" />
                                </div>
                                <div>
