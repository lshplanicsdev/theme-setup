...
<head>
    ...
    @vite(['resources/assets/vendor/css/core.css', 'resources/assets/css/demo.css', 'resources/assets/vendor/fonts/iconify-icons.css', 'resources/assets/vendor/libs/node-waves/node-waves.css', 'resources/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css', 'resources/assets/vendor/libs/datatables-bs5/datatables.bootstrap5.css', 'resources/assets/vendor/libs/datatables-responsive-bs5/responsive.bootstrap5.css', 'resources/assets/vendor/libs/datatables-buttons-bs5/buttons.bootstrap5.css', 'resources/assets/vendor/libs/tagify/tagify.css', 'resources/assets/vendor/libs/animate-css/animate.css', 'resources/assets/vendor/libs/sweetalert2/sweetalert2.css', 'resources/assets/vendor/libs/select2/select2.css', 'resources/assets/vendor/libs/@form-validation/form-validation.css'])
                                        ...
                                        <div class="user-avatar-section">
                                            <div class="d-flex align-items-center flex-column">
                                                <img class="img-fluid rounded-3 mb-4"
                                                    src="../../assets/img/avatars/1.png" height="120"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="list-unstyled g-2 my-6">
                                            <li class="mb-2 d-flex align-items-center">
                                                <i
                                                    class="icon-base ri ri-circle-fill icon-10px text-body me-2"></i><span>10
                                                    Users</span>
                                            </li>
                                            <li class="mb-2 d-flex align-items-center">
                                                <i
                                                    class="icon-base ri ri-circle-fill icon-10px text-body me-2"></i><span>Up
                                                    to 10 GB storage</span>
                                            </li>
                                            <li class="mb-2 d-flex align-items-center">
                                                <i
                                                    class="icon-base ri ri-circle-fill icon-10px text-body me-2"></i><span>Basic
                                                    Support</span>
                                            </li>
                                        </ul>
                                        <div
                                            class="d-flex justify-content-between align-items-center mb-1 fw-medium text-heading">
                                            <span>Days</span>
                                        ...
                                        @foreach ($menus as $menu)
                                            <li class="nav-item">
                                                <a class="nav-link active" href="javascript:void(0);"><i
                                                        class="icon-base ri ri-group-line icon-sm me-2"></i>{{ $menu->title }}</a>
                                            </li>
                                        @endforeach
                                    </ul>
                                </div>
                                        ...
                                        <ul class="timeline mb-0 mt-2">
                                            ...
                                            <li class="timeline-item timeline-item-transparent">
                                                ...
                                                <div class="timeline-event">
                                                    ...
                                                    <div
                                                        class="d-flex justify-content-between flex-wrap gap-2 mb-1_5">
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" id="modalEditTaxID"
                                                        name="modalEditTaxID" class="form-control modal-edit-tax-id"
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="form-floating form-floating-outline">
                                                    <input id="modalEditUserLanguage" name="modalEditUserLanguage"
                                                        ...
                                                        placeholder="select technologies" value="English" />
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-simple modal-upgrade-plan">
                                <div class="modal-content p-8 p-md-12">
                                    <div class="modal-body pt-md-0 px-0">
                                        ...
                                        <form id="upgradePlanForm" class="row g-4 d-flex align-items-center"
                                            onsubmit="return false">
                                            <div class="col-sm-9">
                                                <select id="choosePlan" name="choosePlan"
                                                    class="form-select form-select-sm" aria-label="Choose Plan">
                                    ...
                                    <div class="modal-body pb-md-0 px-0">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                                            <div class="d-flex justify-content-center me-2">
                                                ...
                                                <h1 class="mb-0 text-primary">99</h1>
                                                <sub
                                                    class="h5 pricing-duration mt-auto mb-3 small fw-normal">/month</sub>
                                            </div>
